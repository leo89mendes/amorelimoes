...
if ( ! class_exists( __NAMESPACE__ . '\\IconShortcode' ) ) {
	/**
	 * Class IconShortcode
	...
	class IconShortcode extends AbstractShortcode {
		...
		protected function getCssAssetHandles() {
			return array( AssetHandle::fontAwesome() );
		}
		...
		protected function buildDefaultAttributesConfig( ShortcodeFieldConfigBuilder $builder ) {
			$builder
				...
				->listBox( 'position', esc_html__( 'Position', 'pikart-base' ), array(
					'default' => 'normal',
					'options' => array(
						'normal' => 'Normal',
						'left'   => 'Left',
				...
				->listBox( 'flip', esc_html__( 'Flip', 'pikart-base' ), array(
					'default' => 'default',
					'options' => array(
						'default'    => 'Default',
				...
				->cssClass()
				->label( esc_html__( 'Icon Colors', 'pikart-base' ), array(
					'classes' => 'pikode-inner-subtitle',
				) )
				->customColorPicker( 'text_color', esc_html__( 'Icon', 'pikart-base' ) )
				->customColorPicker( 'text_hover_color', esc_html__( 'Icon hover', 'pikart-base' ) )
				...
				->label( esc_html__( 'Icons List', 'pikart-base' ), array(
					'classes' => 'pikode-inner-subtitle',
				) )
				->icon( 'icon', '', array(
					'icon_list' => $this->getIconList(),
					'classes'   => 'pikode-icon-list'
				) );
		}
